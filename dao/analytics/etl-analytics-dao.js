...
module.exports = function () {
    return {
        ...
        getPatientListReportByIndicatorAndLocation: function getPatientListReportByIndicatorAndLocation(request, callback) {
            ...
            if (requestIndicators === undefined || reportName === undefined)
                callback(Boom.badRequest('Either report or indicator parameter is missing from your api call'));
            ...
            if (!_.isEmpty(queryParts)) {
                ...
                callback(Boom.badRequest('An error occurred while generating patient list, please check parameter and try again'));
            }
        }
    };
}();
